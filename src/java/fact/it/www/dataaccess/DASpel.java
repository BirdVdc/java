 ...
 */
    ...
    return spel;
        ...
        public Spel getSpelNaarKeuze(String spelNaam) {
        Spel spel = null;
        
        try (
                Connection connection = DriverManager.getConnection(url, login, password);
                PreparedStatement statement = connection.prepareStatement("SELECT * FROM spel where like ?");
                statement.setString(1, "%" + spelNaam + "%");
